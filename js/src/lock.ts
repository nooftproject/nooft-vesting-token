...
const now = new Date();
const date1 = new Date(now.getTime() + 1*60000); //after 1 min
const date2 = new Date(now.getTime() + 2*60000); // after 2 min
const date3 = new Date(now.getTime() + 3*60000); // after 3min
const date4 = new Date(now.getTime() + 4*60000); // after 4min
const date5 = new Date(now.getTime() + 5*60000); // after 5 min
const DATES = [
  // new Date(),
...
const AMOUNT_PER_SCHEDULE = [100, 200, 300, 400, 500]; // 100 every min
